...
public static class ScreenUtils
{
    ...
    // cached for efficient boundary checking (added zScreen for our Vector3)
    static float screenLeft;
    static float screenRight;
    static float screenTop;
    static float screenBottom;
    static float zScreen;
    ...
    /// <summary>
    /// Gets the z for the screen in world cordinates
    /// </summary>
    ...
    public static void Initialize()
    {
        ...
        // save screen edges and z in world coordinates
        ...
        zScreen = lowerLeftCornerWorld.z;
    }
