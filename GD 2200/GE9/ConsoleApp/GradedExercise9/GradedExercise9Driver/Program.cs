...
namespace GradedExercise9Driver
{
    /// <summary>
    /// Graded Exercise 9 driver
    /// </summary>
    internal class Program
    {
        ...
        /// <summary>
        /// Tests the Graded Exercise 9 classes
        /// </summary>
        ...
        static void Main(string[] args)
        {
            ...
            invoker.gameObject = new GameObject(0,
                new Transform(Vector3.zero));
            Listener listener = new Listener();
            listener.gameObject = new GameObject(1,
                new Transform(Vector3.zero));
